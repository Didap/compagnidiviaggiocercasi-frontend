...
<template>
  <div class="relative h-[100dvh] overflow-hidden bg-bg-primary flex flex-col">
    ...
    <div class="absolute inset-0 pointer-events-none select-none overflow-hidden z-0">
      <img src="@/assets/macchia.png" alt="" class="absolute -top-40 -left-40 w-[500px] h-auto opacity-30 mix-blend-multiply animate-pulse-slow" />
      <img src="@/assets/macchia.png" alt="" style="rotate: 180deg" class="absolute -bottom-40 -right-40 w-[600px] h-auto opacity-30 mix-blend-multiply animate-pulse-slow -scale-x-100" />
      <img src="@/assets/line.png" alt="" class="absolute bottom-0 left-0 w-[20%] max-w-[250px] h-auto object-contain opacity-20 animate-fade-in-path hidden md:block" />
      <img src="@/assets/line.png" alt="" class="absolute top-0 right-0 w-[20%] max-w-[250px] h-auto object-contain opacity-20 transform rotate-180 animate-fade-in-path hidden md:block" />
    </div>

    <!-- Floating Elements -->
    <div class="absolute inset-0 pointer-events-none select-none overflow-hidden z-10">
      <img src="@/assets/globe.png" alt="" class="absolute top-32 left-[8%] w-12 sm:w-20 h-auto opacity-50 mix-blend-multiply animate-rotate-slow" />
      <img src="@/assets/airplane-passport.png" alt="" style="rotate: 30deg" class="absolute bottom-24 right-[8%] w-20 sm:w-28 h-auto animate-float drop-shadow-lg opacity-80" />
    </div>
    ...
    <div class="flex-1 flex items-center justify-center px-5 sm:px-4 relative z-20">
      <div class="w-full max-w-md">
        ...
        <div class="text-center mb-6">
          <span class="inline-block py-1 px-3 rounded-full bg-secondary/10 text-secondary font-semibold text-xs tracking-widest uppercase mb-3">
            Area Riservata
          </span>
        ...
        <!-- Form Card -->
        <div class="bg-white/80 backdrop-blur-md rounded-3xl shadow-xl shadow-primary/5 border border-white/60 p-6 sm:p-8">
          <form @submit.prevent="handleSubmit" class="space-y-4 sm:space-y-5">
            <!-- Error -->
            <div v-if="error" class="bg-red-50/80 text-red-600 text-sm rounded-2xl px-4 py-2.5 border border-red-100/50">
              {{ error }}
            </div>
